...
# NAME_DOMAIN_COL = 'website'
NAME_COMPANY_COL = 'domains'
...
#put the coloumn heading here
        keyword = search_keywords[NAME_COMPANY_COL][i]
        ...
        data_entries['domain_name'].append(search_keywords[NAME_COMPANY_COL][i])
