...
DATA_COLUMNS =['company_name','website','headquarters','SIC Code','NAICS Code','revenue','Number of Employees','LinkedIn url' ] 
...
def urlScrape(url):
    ...
    try:
        company_name = soup.select_one(CSS_SELECTORS['company_name']).text
    except:
...
def scrape_data(link_files_path, save_progress_every=20, start=0, end=-1):
    ...
    for i in range(start, end):
        ...
        # final_data["company_name"].append(data[company_na])
